...
impl ChatWidget {
    ...
    fn on_session_configured(&mut self, event: codex_protocol::protocol::SessionConfiguredEvent) {
        ...
        self.nero_auto_runtime = nero_auto_runtime;
    ...
    pub(crate) fn handle_server_notification(
        ...
        match notification {
            ...
            ServerNotification::ThreadWarning(notification) => {
    ...
    fn should_apply_nero_auto_hotkey_action(&mut self, action: NeroAutoHotkeyAction) -> bool {
        ...
        if let (Some(last_action), Some(last_at)) = (
            ...
            && now.duration_since(last_at) < debounce
        {
            return false;
        }
    ...
    #[cfg(test)]
    pub(crate) fn is_subagent_session(&self) -> bool {
