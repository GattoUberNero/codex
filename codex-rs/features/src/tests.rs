...
#[test]
fn multi_file_reader_is_under_development_and_disabled_by_default() {
    assert_eq!(Feature::MultiFileReader.stage(), Stage::UnderDevelopment);
    assert_eq!(Feature::MultiFileReader.default_enabled(), false);
}
